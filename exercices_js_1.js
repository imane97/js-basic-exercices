...
// impair();
   ...
   function divisibleBy5(){
     ...
     for( var i = 0; i<2; i++){
      var aleatoire1 = Math.random()*10;
      var aleatoire2  = aleatoire1.toPrecision(1);
      console.log("nombre généré aléatoirement: "+aleatoire2);
      if(aleatoire2/5 == 0 || aleatoire2/5 == 5){
        divisible[i]=aleatoire2;
        var stock = aleatoire2/5;
      }else{
        nonDivisible[i]= aleatoire2;
        var nonStock = aleatoire2/5;
      }
      for(var n = 0; n<divisible.length; n++){
        console.log("la valeur : "+ divisible[i]+" est présente dans le tableau DIVISIBLE car "+divisible[i]+" /5 = "+stock);
        console.log("la valeur : "+ nonDivisible[i]+" est présente dans le tableau NON DIVISIBLE car "+nonDivisible[i]+" /5 = "+nonStock);
      }
     }
   }
   divisibleBy5();
